...
class MakeData2Graph(object):
    ...
    #         return df[end-1,0]  # idx가 row개수보다 커버리게 되면, 맨 마지막 close값을 줘라.
...
def excute_data_handling():
    ...
    print('라벨데이터와 주식데이터 로딩을 완료하였습니다.')
    return label, y_data
...
# label , y_data = excute_data_handling()
# labels = excute_data_handling()